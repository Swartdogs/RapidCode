...
public class RobotContainer extends SubsystemBase
{
    ...
    private void configureButtonBindings()
    {
        ...
        _driveJoystick.getButton( 8).whenActivated(shootFender);
                                                                                // Shoot without aiming from the Fender
        ...
        // _coDriveJoystick.getButton(8).whenActivated(SwartdogCommand.run(()-> 
        // {
        //     _drive.setGyro(0);
        //     _drive.resetOdometer();
        // }));

        // _coDriveJoystick.getButton(10).whenActivated(new CmdDriveToPosition(_drive, new Vector(36, 0), 90, 0.5, 0.5, 0, true));
        // _coDriveJoystick.getButton(12).whenActivated(new CmdDriveToPosition(_drive, new Vector(36, 0), 90, 0.5, 0.5, 0, false));
